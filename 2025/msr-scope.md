...
- [MSR Scope](#msr-scope)
  ...
  - [MSR\_PKG\_CST\_CONFIG\_CONTROL](#msr_pkg_cst_config_control)
  - [Example](#example)
...
# Current values are: pkg_cstate_limit = PC6 = 2 in bits 2-0
...
MSR bits on a real system. See
[tools/msr-ioscope](https://github.com/intel/pepc/tree/main/tools/msr-ioscope).
