...
- [Xeon C6P and C6SP Idle States](#xeon-c6p-and-c6sp-idle-states)
...
[C-state Namespaces](cstate-namespaces.md).
...
This includes Emerald Rapids Xeon and earlier server platforms, such as Sapphire Rapids, Ice
